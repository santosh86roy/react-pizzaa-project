  ...
  const products = [
    {
      category: "Pizza",
      items: [
        { name: "Farmhouse", price: 140 },
        { name: "Peppy Paneer", price: 180 },
        { name: "Italian Pizza", price: 200 },
        { name: "Margherita Pizza", price: 240 },
        { name: "Primavera Gourmet Pizza", price: 280 },
        { name: "Al Fungi Gourmet Pizza", price: 280 },
        { name: "Veg Extravaganza Pizza", price: 300 },
        { name: "Veggie Paradise Pizza", price: 320 },
        { name: "Indi Tandoori Paneer Pizza", price: 360 },
        { name: "Mexican Green Wave Pizza", price: 375 },
        { name: "Double Cheese Margherita Pizza", price: 380 },
      ],
    },
    {
      category: "Burger",
      items: [
        ...
        { name: "Vegetable Burger", price: 180 },
        // { name: "Elk Burger", price: 200 },
        // { name: "Veggie Burger", price: 240 },
        { name: "Double Cheese Burger", price: 280 },
        { name: "Aaloo Tikki Burger", price: 180 },
      ],
    },
    {
      category: "Soft Drink",
